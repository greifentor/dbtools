...
public class CopyCommand implements Command {
	...
	@Parameter(
		names = { "--sourceUser" },
		required = true,
		description = "The name of the user for source database " + "access."
	)
	private String sourceUserName;

	@Parameter(
		names = { "--sourcePassword" },
		required = false,
		description = "The password of the user for source database " + "access."
	)
	...
	@Parameter(
		names = { "--targetDriver" },
		required = true,
		description = "The qualified class name of the JDBC driver for the " + "target database."
	)
	...
	@Parameter(
		names = { "--targetUser" },
		required = true,
		description = "The name of the user for target database " + "access."
	)
	private String targetUserName;

	@Parameter(
		names = { "--targetPassword" },
		required = false,
		description = "The password of the user for target database " + "access."
	)
	private String targetUserPassword = "";

	@Parameter(
		names = { "--tableNamePattern" },
		required = false,
		description = "A pattern for table names whose data " +
	...
	@Parameter(
		names = { "--tableNameMappings" },
		required = false,
		description = "Mappings for table names which are " +
